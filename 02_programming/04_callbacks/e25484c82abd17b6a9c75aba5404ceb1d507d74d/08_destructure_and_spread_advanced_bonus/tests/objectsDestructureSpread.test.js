...
describe("Destructuring and spread with objects", () => {
  describe("#getConfig", () => {
    test("Should take an optional object parameter", async () => {
    ...
    test("Should return the overriden configuration", () => {
      const userConfig = {
        user: {
          name: "John",
          password: "123123",
    ...
    test("Should not use any conditional statement", async () => {
      const userConfig = {
        user: {
          name: "John",
          password: "123123",
  ...
  describe("#logInfos", () => {
    ...
    test("Should not crash when called with no user", () => {
      let error;
      try {
        logInfos();
      } catch (e) {
    ...
    test("Should complete with '<REDACTED>' for missing infos", () => {
